      ...
      <div className={`${load ? "hidden" : ""}`}>
        <div className="mx-40 my-8 bg-[#f3f3f3] p-[72px] rounded-2xl">
          ...
          <p className="text-center text-base font-medium mt-4 w-3/4 mx-auto text-gray-500">
            Whether you’re facing legal challenges or simply seeking
            professional advice, our expert lawyers are here to help. Browse
            detailed profiles to learn more about each lawyer’s qualifications,
            specialties, availability, and consultation fees—so you can choose
            the right advocate for your needs with confidence.
          </p>
        </div>
        ...
        <div className="mx-40 border p-10 border-gray-300 rounded-2xl mb-[98px]">
          ...
          <div className="badge bg-[#FFA0001A] text-[#FFA000] p-3.5 font-medium rounded-4xl mt-[16.5px] border border-gray-100 h-[38px]">
            ...
            Due to high client volume, we are currently accepting appointments
